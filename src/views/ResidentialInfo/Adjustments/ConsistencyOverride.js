...
class ConsistencyOverride extends Component {
  ...
  render() {
    const {consistencyOverride, isLoading, foodGroups} = this.props;
        ...
        <Col xs="12" sm="12" lg="12">
          {
            isLoading ? <Skeleton /> :
              <CustomGrid
                ...
                dataSource={consistencyOverride || []}
              ...
              >
                ...
                <Column alignment="left" caption={'Allergy/Item/Food/Menu'} width={'20%'} dataField={'menu'}/>
...
export default ConsistencyOverride
