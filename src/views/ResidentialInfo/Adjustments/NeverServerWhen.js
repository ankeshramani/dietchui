...
class NeverServerWhen extends Component {
  render() {
    const {neverServe, isLoading, neverServeWhen} = this.props;
    return(
      <Row>
        <Col xs="12" sm="12" lg="12">
          {
            isLoading ? <Skeleton /> :
              <CustomGrid
                ...
                dataSource={neverServe || neverServeWhen ||  []}
...
export default NeverServerWhen
